$(document).ready(function(){
  ...
  //url to your webhook
	...
	$('#contactFormSubmitButtonPA1').click(function(){
  //url to your webhook
	  var webHookUrl="https://hooks.slack.com/services/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";
	  var email = $('.form-email').val();
  	if(!email){$('.form-error').show();return;}
  ...
  "use strict";
	...
	if($('.instafeed').length){
		jQuery.fn.spectragram.accessData = {
			accessToken: '1286702936.fd0f4c7.faa35244e30d4130a9b6bb68cbbc8076',
			clientID: 'fd0f4c762ad14a149a9d256c3b6924d2'
		};
	...
	/**if($('.instafeed').length){
		...
		$('.instafeed').children('ul').spectragram('getUserFeed', {
				query: 'thigafr',
				max: 6,
   				size: 'medium',
   				wrapEachWith: '<li></li>'
