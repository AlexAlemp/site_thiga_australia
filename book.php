...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Thiga Academy - Product Academy 1</title>
        <meta name="description" content="Le guide des Product Managers et Product Owners d'élite : tout savoir sur les meilleures pratiques de Product Management">
    ...
    <body id="book-page">
		...
		<section class="product-right">
				...
				<div class="product-image2 " data-scroll-reveal="enter right and move 100px">
