...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Thiga Australia - Product Academy 1</title>
        <meta name="description" content="A Guide to Agile Product Management. Written by our Thiguys, this book will give you the best practices to build the right product, and build it right.">
		...
		<section class="feature-divider">
              ...
              <div class="photo-form-wrapper clearfix">
                <form class="email-form">
                  <input style="display: inline-block;width:50%;margin-right:20px;" class="form-email validate-required validate-email" type="text" placeholder="email" name="email">
            ...
            <div class="col-md-7 col-sm-6 centered-text" data-scroll-reveal="enter right and move 100px">
							<img width="70%" alt="Product Image" src="/img/product-academy/pa1.png">
						</div>
					</div>
		...
		<section class="side-image text-heavy clearfix">
			...
			<section class="side-image clearfix">
				...
				<div class="image-container col-md-5 col-sm-3 pull-right">
					<div class="background-image-holder">
						<img class="background-image" alt="Background Image" src="/img/team/equipe-pa1-2015-min.jpg">
					</div>
				</div>
