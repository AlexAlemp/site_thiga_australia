...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="http://thiga.com.au/" rel="canonical">
				...
				<div class="container">
					...
					<div class="row client-row">
						<div class="row-wrapper">
							...
							<div class="col-sm-3 text-center">
								<img alt="client" src="/img/clients/bnp-min.png">
							</div>
							...
							<div class="col-sm-3 text-center">
								<img alt="client" src="/img/clients/prestashop.png">
							</div>
						</div>
					</div>
					<div class="row client-row">
						<div class="row-wrapper">
							...
							<div class="col-sm-3 text-center">
								<img alt="client" src="/img/clients/ing.png">
							</div>
			...
			<section id="home-livres" class="strip feature-divider">
                ...
                <a href="/book" class="btn btn-primary9 btn-filled">Get the book</a>
						...
						<div class="col-md-7 col-sm-6 centered-text" data-scroll-reveal="enter from bottom and move 100px">
  					       <img width="50%" alt="Product Image" src="/img/product-academy/pa1.png">
  					</div>
						</div>
					</div>
				</div>
